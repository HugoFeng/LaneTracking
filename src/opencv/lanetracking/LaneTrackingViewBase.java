...
public abstract class LaneTrackingViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    private static final String TAG = "LaneTracking::BaseView";

    private SurfaceHolder       mHolder;
    private VideoCapture        mCamera;

    public LaneTrackingViewBase(Context context) {
        super(context);
        mHolder = getHolder();
